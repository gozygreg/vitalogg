  ...
  return (
    <>
      <div className="bg-myBrown py-12">
        <div className="flex flex-col justify-center mx-[] gap-0 md:flex-row gap-[4rem] justify-center items-start mx-[5rem] lg:mx-[10rem]">
          <div className="w-full md:flex-grow w-1/2 lg:flex-grow w-1/2 xl:[]">
            <h1 className="pt-10 text-4xl font-medium pb-6 md:text-4xl pt-0 lg:text-5xl pt-0">
          ...
          <div className="w-full md:flex-grow w-1/2 ">
            <div className="pt-10 pb-6 lg:pt-0 pb-6">
              <h2 className="text-lg font-medium">What is VitaloG ?</h2>
              <p className="text-[12px] italic pt-4 font-medium w-[500px] md:w-[400px] lg:w-[500px]">
