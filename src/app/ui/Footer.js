    ...
    <>
      <div className="bg-deepGreen block md:flex flex-row gap-[2rem] lg:flex flex-row gap-[5rem] items-center px-10 xl:gap-[10rem]">
        <div className="mr-20 md:mx-10 lg:mx-20 py-20">
          ...
          <div className="text-white block gap-[0rem] ml-[0rem] mb-0 pb-2 md:flex flex-row gap-[2rem] lg:flex flex-row gap-[2.8rem] mb-10 xl:gap-[10rem]">
            <div className="pb-4 lg:pb-0">
              <h2 className="font-semibold text-xl md:text-[15px] lg:text-[15px] mt-[15px] pb-2 text-left">Quick Links</h2>
            ...
            <div className="pb-4 lg:pb-0">
              <h2 className="font-semibold text-xl mt-0 md:text-[15px] mt-[-25px] lg:text-[15px] mt-[15px] pb-2 text-left">VitaloG</h2>
              <ul className="text-xs text-left">
            ...
            <div className="pb-4 lg:pb-0">
              <h2 className="font-semibold text-xl md:text-[15px] mt-[-25px] lg:text-[15px] mt-[15px] pb-2 text-left">Information</h2>
              <ul className="text-xs text-left">
